...
public class RetrofitActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Will log all the events we are performing regarding Retrofit including the request we send and response we get back.
        ...
        // provide the implementations of methods ( i.e we don't need to write the body of methods ).
    ...
    private void getComments()
    {
        ...
        // If whole query parameter string is passed is passed. Here you can the whole URL also and in this case it will replace the base URL
        // defined while creating the instance of the Retrofit.
